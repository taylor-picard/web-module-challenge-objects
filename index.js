...
console.log('1a:', createMenuItem('tacos', 8, 'Lunch'));
...
console.log('1b:', createMenuItem('waffles', 8, 'Breakfast'));
console.log('1b:', createMenuItem('icecream', 4, 'Dessert'));
...
console.log('2:', burger.discount('public'));
...
console.log(addReview(reviews, 'Taylor', 5, 'Great food'));
